...
# 1.创建版本库
  ...
  所以创建一个版本库也非常简单，如下我是D盘 目录下新建一个testgit版本库。![创建版本库](https://img-blog.csdnimg.cn/20190513153354897.jpg?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L2lpbXBhY3Q=,size_16,color_FFFFFF,t_70)
...
git pull也失败了，原因是没有指定本地dec分支与远程origin/dec分支的链接，根据提示，设置dev和origin/dev的链接：如下：![在这里插入图片描述](https://img-blog.csdnimg.cn/2019051321193149.jpg)
